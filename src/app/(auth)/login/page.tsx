...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        {/* Demo credentials */}
        <div className="mt-4 p-4 bg-gray-800/30 border border-gray-700/50 rounded-lg text-sm text-gray-400">
          <p className="font-medium text-gray-300 mb-1">Demo Account:</p>
          <p>Email: demo@cloudcode.dev</p>
